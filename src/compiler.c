...
// Hide C's syntax for function pointer types behind typedef
// This is a function type that takes no args and returns nothing
typedef void (*ParseFn)(bool canAssign);

// This is a row in the parser table
typedef struct {
    ParseFn prefix;
    ParseFn infix;
